      ...
      <header className={styles.header}>
        ...
        >
          ...
          >
            ...
            <div className={styles.menuLinks}>
              {menuItems.map((item, index) => (
                <Link
                  ...
                  href={item.href}
                  onClick={closePanels}
                  className={index === 0 ? styles.activeLink : ""}
                >
            ...
            <Link className={styles.workButton} href="#work" onClick={closePanels}>
              ALL OUR WORK
            </Link>
          </nav>
        </div>

        <Link className={styles.logo} href="/" aria-label="Graphic Wolves home page">
          <Image
